...
# environment anyway
# This worked but turns out soupsieve checks for Tag instances specifically so
# this fails in a whole bunch of edge cases
#bs4.Tag = SoupTag
